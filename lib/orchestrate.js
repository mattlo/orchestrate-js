...
/**
 * Web evaluator
 * @param {Function} evalFn function
 * @param {Page} page
 * @returns {Q.promise}
 */
o.eval = function (evalFn, page) {
	// @TODO validate `page` context has a loaded page before performing eval
	
	var deferred = Q.defer();
	
	// run phantom evaluator
	(page || mainPage).evaluate(evalFn, function() {
...
/**
 * Delegates global event emitter
